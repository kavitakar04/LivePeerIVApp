...
def _compute_atm_curve_simple(df: pd.DataFrame, atm_band: float = DEFAULT_ATM_BAND) -> pd.DataFrame:
    """Backward-compatible wrapper around analysis.views.correlation_view."""
...
def compute_and_plot_correlation(
    ...
    **weight_config,
    ...
    :func:`analysis.weights.unified_weights.compute_unified_weights`. Additional weight
