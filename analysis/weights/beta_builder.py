...
def peer_weights_from_correlations(
    ...
    Active callers should use :func:`analysis.weights.weight_service.compute_peer_weights`,
    which routes through :mod:`analysis.weights.unified_weights` and applies the shared
...
def build_peer_weights(
    ...
    *,
    ...
    New code should call :func:`analysis.weights.weight_service.compute_peer_weights`.
